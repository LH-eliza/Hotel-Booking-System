...
const AdminDashboard: React.FC = () => {
  ...
  const handleNewHotel = async () => {
    if (!formData.address || !formData.category || !formData.email || !formData.hotelChain || !hotelChainData.nextHotelID) {
      alert("Please fill in all fields");
      console.log(formData.address, formData.category, formData.email, formData.hotelChain, hotelChainData.nextHotelID)
      return;
    }
  ...
  `;
    ...
    const values = [hotelChainData.nextHotelID, formData.hotelChain, formData.address, 1, formData.email, formData.category];
                      ...
                      <tbody>
                        {hotelRecords.map((hotel) => (
                          <tr key={hotel.hotel_id} className="hover:bg-gray-50">
                            ...
                            <td className="py-3 px-4 border-b border-gray-200">
                              <div className="flex space-x-2">
                              <button className="p-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200" onClick={() => handleEditHotel(hotel.chain_id, hotel.hotel_id, hotel.address, hotel.num_rooms, hotel.contact_email, hotel.star_category)}>
                                  <Edit size={16} />
                                </button>
                      ...
                      <tbody>
                        {rooms.map((room) => (
                          <tr key={room.room_id} className="hover:bg-gray-50">
                            ...
                            <td className="py-3 px-4 border-b border-gray-200">
                              <div className="flex space-x-2">
                                <button className="p-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200" onClick={() => handleEditRoom(room.room_id, room.hotel_id, room.price, room.capacity, room.view, room.extendable, room.status)}>
                                  <Edit size={16} />
                                </button>
                      ...
                      <tbody>
                        {customers.map((customer) => (
                          <tr key={customer.customer_id} className="hover:bg-gray-50">
                            ...
                            <td className="py-3 px-4 border-b border-gray-200">
                              <div className="flex space-x-2">
                                <button className="p-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200" onClick={() => handleEditCustomer(customer.customer_id, customer.first_name, customer.last_name, customer.address, customer.id_type, customer.id_number, customer.registration_date)}>
                                  <Edit size={16} />
                                </button>
                      ...
                      <tbody>
                        {employees.map((employee) => (
                          <tr key={employee.ssn} className="hover:bg-gray-50">
                            ...
                            <td className="py-3 px-4 border-b border-gray-200">
                              <div className="flex space-x-2">
                                <button className="p-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200" onClick={() => handleEditEmployee(employee.ssn, employee.hotel_id, employee.first_name, employee.last_name, employee.address, employee.role)}>
                                  <Edit size={16} />
                                </button>
  ...
  Edit {modalType === "hotel" ? "Hotel" 
       : modalType === "room" ? "Room" 
       : modalType === "customer" ? "Customer" 
       : modalType === "employee" ? "Employee" 
       : "Item"}
</h3>
          ...
          <>
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditHotelData({ ...editHotelData, chain_id: e.target.value })}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditHotelData({ ...editHotelData, hotel_id: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
                disabled
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditHotelData({ ...editHotelData, num_rooms: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditHotelData({ ...editHotelData, contact_email: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditHotelData({ ...editHotelData, starcategory: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
              />
            </div>
          </>
          ...
          <>
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditRoomData({ ...editRoomData, room_id: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
                disabled
              />
            </div>
            ...
            <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="extendable"
                            onChange={(e) => setEditRoomData({ ...editRoomData, extendable: e.target.checked })}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditRoomData({ ...editRoomData, view: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
              />
            </div>
  ...
  <>
    <div>
      ...
      <input
        ...
        onChange={(e) => setEditCustomerData({ ...editCustomerData, customer_id: e.target.value })}
        className="w-full border border-gray-300 rounded px-3 py-2"
        disabled
      />
    </div>
    ...
    <div>
              ...
              <select
                ...
                onChange={(e) => setEditCustomerData({ ...editCustomerData, id_type: e.target.value })}
                className="w-full border border-gray-300 rounded px-3 py-2"
              >
      ...
      <input
        ...
        onChange={(e) => setEditCustomerData({ ...editCustomerData, id_number: e.target.value })}
        className="w-full border border-gray-300 rounded px-3 py-2"
      />
    </div>
  </>
...
{modalType === "employee" && (
  <>
    <div>
      <label className="block text-sm font-medium text-gray-700">Employee SSN</label>
      <input
        type="text"
        value={editEmployeeData.ssn}
        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, ssn: e.target.value })}
        className="w-full border border-gray-300 rounded px-3 py-2"
        disabled
      />
    </div>
    ...
    <div>
      ...
      <input
        ...
        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, hotel_id: e.target.value })}
        className="w-full border border-gray-300 rounded px-3 py-2"
        disabled
      />
    </div>
